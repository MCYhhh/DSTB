        ...
        <div class="login_box">
            ...
            <div class="login_content">
                ...
                <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="80px" >
                    <el-form-item label="用户账号" prop="waccount" class="item">
                        <el-input v-model="loginForm.waccount" prefix-icon="el-icon-user-solid" ></el-input>
                    </el-form-item>
                    <el-form-item label="用户密码" prop="wpwd" class="item">
                        <el-input v-model="loginForm.wpwd" prefix-icon="el-icon-unlock" type="password"></el-input>
                    </el-form-item>
                    <!-- <el-form-item label="确认密码" prop="checkupwd">
                        <el-input v-model="loginForm.checkupwd" prefix-icon="el-icon-unlock" type="password"></el-input>
                    </el-form-item> -->
...
<script>
// prop属性设置为需校验的字段名
import { loginWokerApi } from "@/api/index";
export default ({
    data(){
        return{
            //这是登录表单的数据绑定对象
       ...
       login(){
        this.$refs.loginFormRef.validate(async (valid) =>{
          if(valid){
            ...
            console.log(json);
            const {data: res}=await loginWokerApi(json);
            console.log(res);
            if(res.code!==200)
